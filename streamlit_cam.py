...
def annotate_image(image):
    ...
    if person_detected:
        ...
        product_weight_file_path = "best_obj_detect_prod_types.pt" # Update with actual path
        product_model = YOLO(product_weight_file_path)

        # Load the trained YOLO model for logo detection
        logo_weight_file_path = "best_obj_detect_logos.pt" # Update with actual path
        ...
        for person_id, box in person_boxes.items():
            ...
            if label_text:
                ...
                detr_draw.text((x_min, y_min - 40), label_text, font=ImageFont.truetype("arial.ttf", size=12), fill="blue")
